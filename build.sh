...
case ${PLATFORM_NAME} in
    iphoneos)
        export CC="clang -arch arm64 --target=arm64-apple-ios -mios-version-min=12.2 -fobjc-weak  -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk -DUSE_GLES -DAAPI_SDL2 -DWAPI_SDL2 -D__IOS__=1"
        export CXX="clang++ -arch arm64 -mios-version-min=12.2 -fobjc-weak -std=c++11 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk -DUSE_GLES -DAAPI_SDL2 -DWAPI_SDL2 -D__IOS__=1"
        ...
        ;;
    iphonesimulator)
        export CC="clang -arch $(eval "uname -m") -mios-simulator-version-min=12.2 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator.sdk -DUSE_GLES -DAAPI_SDL2 -DWAPI_SDL2 -fobjc-weak -D__IOS__=1"
        export CXX="clang++ -arch $(eval "uname -m") -mios-simulator-version-min=12.2 -fobjc-weak -std=c++11 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator.sdk -DUSE_GLES -DAAPI_SDL2 -DWAPI_SDL2 -D__IOS__=1"
        export TARGET_OS_IOS=1
...
gmake -j6 TARGET_IOS=1 TARGET_IOS_SIM=$TARGET_OS_IOS_SIM
