...
//
//@property (weak, nonatomic) IBOutlet UIView* m_group_lr;
//@property (weak, nonatomic) IBOutlet UIView* m_group_joystick;
//@property (weak, nonatomic) IBOutlet UIView* m_group_startmenu;
